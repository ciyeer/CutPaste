...
#ifndef CCAMPLIFIER_H
#define CCAMPLIFIER_H
#include <memory>
#include <QWidget>
 ...
 */
class CCAmplifier : public QWidget
{
    Q_OBJECT
public:
    explicit CCAmplifier(std::shared_ptr<QPixmap> originPainting, QWidget *parent = nullptr);
