#ifndef CCMODELVIEW_H
#define CCMODELVIEW_H
...
class CCModelView : public QWidget
{
    Q_OBJECT
...
private:
    typedef void (CCModelView::*PDRAWFUNC)
...
public:
    explicit CCModelView(MODEL model = MODEL::Arrows,
                         QWidget *parent = 0);
