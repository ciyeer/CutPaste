...
CCModelView::CCModelView(MODEL model,
        QWidget *parent) : QWidget(parent),
        color_(Qt::red) {
    /// 确定画图样式
    switch (model) {
    case MODEL::Arrows:
        drawFunc_ = &CCModelView::drawArrows;
        break;
    case MODEL::Rectangle:
        drawFunc_ = &CCModelView::drawRect;
        break;
    case MODEL::Roundness:
        drawFunc_ = &CCModelView::drawEllipse;
        break;
    default:
    {
        drawFunc_ = &CCModelView::drawArrows;
...
void CCModelView::paintEvent(QPaintEvent *) {
...
void CCModelView::drawArrows(const QPoint& startPoint,
...
void CCModelView::drawRect(const QPoint &startPoint, const QPoint &endPoint,
                           QPainter &paiter) {
    paiter.setPen(color_);
    paiter.drawRect(QRect(startPoint, endPoint));
}

void CCModelView::drawEllipse(const QPoint &startPoint, const QPoint &endPoint,
                              QPainter &paiter) {
    paiter.setPen(color_);
    paiter.drawEllipse(QRect(startPoint, endPoint));
}
void CCModelView::onColor(const QColor &color) {
    color_ = color;
}
